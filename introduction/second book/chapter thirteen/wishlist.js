...
let sheButton = document.getElementById("addIt2");
sheButton.addEventListener("click", herAddtheThing);
...
function herAddtheThing() {

    let theThing = document.getElementById("sheWant");
